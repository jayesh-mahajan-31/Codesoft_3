...
def generator():
    ...
    if choice.get()==1:
        pass1=random.sample(small_alphabets,password_length)
        passwordField.insert(0,pass1)

    if choice.get()==2:
        pass2=random.sample(small_alphabets+capital_alphabets,password_length)
        passwordField.insert(0,pass2)

    if choice.get()==3:
        pass3=random.sample(all,password_length)
        passwordField.insert(0,pass3)
